...
namespace Mono.CSharp
{
	...
	{
	    public abstract class EventFieldAccessor : AEventAccessor
		{
	    ...
	    public sealed class AddDelegateMethod: EventFieldAccessor
		{
	    ...
	    public sealed class RemoveDelegateMethod: EventFieldAccessor
		{
