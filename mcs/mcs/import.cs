...
namespace Mono.CSharp
{
	...
	public abstract class ImportedDefinition : IMemberDefinition
	{
	...
	public class ImportedMemberDefinition : ImportedDefinition
	{
    ...
    public class ImportedParameterMemberDefinition : ImportedMemberDefinition, IParametersMember
	{
    ...
    public class ImportedTypeDefinition : ImportedDefinition, ITypeDefinition
	{
		TypeParameterSpec[] tparams;
		string name;
