...
namespace Mono.CSharp {
	...
	public class LocalTemporary : Expression, IMemoryLocation, IAssignMethod {
		LocalBuilder builder_;
        LocalBuilder builder_nonNull;
        ...
        public LocalBuilder Builder_LastNonNull { get { return builder_nonNull; } }
        private LocalBuilder builder
        {
            get { return builder_; }
            set
            {
                if ((builder_nonNull != null) && (value != null))
                    throw new ApplicationException();

                builder_ = value;
                builder_nonNull = value ?? builder_nonNull;
            }
        }
	...
	public class CompoundAssign : Assign
	{
		...
		public sealed class TargetExpression : Expression
		{
            ...
            public Expression Child { get { return child; } }
