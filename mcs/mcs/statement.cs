...
//				return assignable_slots;
	...
	public class ExplicitBlock : Block
	{
		...
		public AnonymousMethodStorey CreateAnonymousMethodStorey (ResolveContext ec)
		{
			...
			if (am_storey == null) {
                ...
                ec.CurrentAnonymousMethod.Storey_Explicit = am_storey;
			}
	...
	{
	    public abstract class Emitter : ShimExpression
		{
	    ...
	    public class ExpressionEmitter : Emitter {
	...
	public class Foreach : Statement
	{
        ...
        public Block Body { get { return body; } }
