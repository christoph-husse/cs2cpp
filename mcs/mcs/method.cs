...
namespace Mono.CSharp {
	...
	public abstract class MethodCore : InterfaceMemberBase, IParametersMember
	{
        ...
        private ToplevelBlock block_lastNonNull;

	    public ToplevelBlock Block_LastNonNull
	    {
            get { return block_lastNonNull; }
            set 
            { 
                block = value;
                block_lastNonNull = value ?? block_lastNonNull;
            }
	    }
...
//					MethodBase mb = new PartialMethodDefinitionInfo (this);
	...
	public class MethodData
	{
        ...
        public MethodAttributes Flags { get { return flags; } }
...
//			else
	...
	public abstract class AbstractPropertyEventMethod : MemberCore, IMethodData {
        ...
        public MethodData MethodData { get { return method_data; } }
