...
namespace Mono.CSharp {
	...
	public class OperatorCast : TypeCast
	{
        ...
        public MethodSpec ConversionOperator { get { return conversion_operator; } }
	}
	...
	public class ReducedExpression : Expression
	{
		public sealed class ReducedConstantExpression : EmptyConstantCast
		{
            ...
            public Expression Original { get { return orig_expr; } }
    ...
    public abstract class PropertyOrIndexerExpr<T> : MemberExpr, IDynamicAssign where T : PropertySpec
	{
	    ...
	    public abstract Arguments Arguments { get; set; }
